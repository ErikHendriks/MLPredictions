...
logging.basicConfig(
    filename='/var/log/indicesPrediction.log',
    level=logging.DEBUG,
    format='%(asctime)s [%(levelname)s] %(name)s : %(message)s',)

conf = [line.strip('\n') for line in open('/etc/oandaV20/indicesPrediction.conf')]
...
symbols = ['AU200_AUD', 'CN50_USD', 'DE30_EUR', 'EU50_EUR', 'FR40_EUR', 'HK33_HKD', 'IN50_USD', 'JP225_USD', 'NAS100_USD', 'NL25_EUR', 'SG30_SGD', 'SPX500_USD', 'TWIX_USD', 'UK100_GBP', 'US30_USD', 'US2000_USD']
params = {'instruments':'AU200_AUD ,CN50_USD ,DE30_EUR ,EU50_EUR ,FR40_EUR ,HK33_HKD ,IN50_USD ,JP225_USD ,NAS100_USD ,NL25_EUR ,SG30_SGD ,SPX500_USD ,TWIX_USD ,UK100_GBP ,US30_USD ,US2000_USD'}
